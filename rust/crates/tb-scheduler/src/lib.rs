//! `tb-scheduler` — Phasenübergänge + Reminder-Hintergrund-Loop des
//! Turnier-Backends.
//!
...
//!    Punkte neu und plant Auto-Lobbys. Wird vom Loop UND von tb-web (Admin-Routen)
//!    aufgerufen.
...
//!   als next_status; der Zweig greift nur bei externen Aufrufern (tb-web).
