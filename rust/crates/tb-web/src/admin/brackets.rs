//! Gruppen-/Bracket-Generierung. Delegiert an [`tb_tournament::generate_groups`],
//! [`tb_tournament::generate_group_matches`] und [`tb_tournament::generate_bracket`].
...
use tb_tournament::{generate_bracket, generate_group_matches, generate_groups};
