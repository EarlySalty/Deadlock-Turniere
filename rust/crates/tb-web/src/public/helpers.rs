    ...
    for g in group_rows {
        ...
        for row in match_rows {
            matches.push(GroupMatch {
                ...
                hero_assignments: tb_core::json::parse_object(
...
pub struct TournamentRowData {
    pub id: i64,
    pub name: String,
    pub status: tb_core::TournamentStatus,
    ...
    pub tournament_mode: tb_core::TournamentMode,
    pub tournament_game_mode: tb_core::TournamentGameMode,
