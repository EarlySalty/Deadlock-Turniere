...
//! mehrere Discord-IDs (gegen N+1 in den Konsumenten tb-web/tb-tournament).
...
/// Öffentliche Schnittstelle zur Rang-Auflösung. Konsumenten (tb-web,
/// tb-tournament) injizieren eine Implementierung.
#[async_trait]
