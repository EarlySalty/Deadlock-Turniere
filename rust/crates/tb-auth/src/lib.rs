//! `tb-auth` — Auth-Logik unterhalb der HTTP-Schicht.
//!
...
//!   [`tb_core::UserSession`] auf (mit Ablaufprüfung + Opportunistic-Cleanup).
...
//! `get_current_user` leben in tb-web und bauen auf diesen Bausteinen auf.
