...
//! (FastAPI-`HTTPException`-Statuscodes), damit tb-web sie 1:1 in Responses
...
/// manuelles Mapping funktioniert. Geht über [`tb_db::DbError`], damit es genau
/// eine Persistenz-Fehler-Repräsentation gibt.
impl From<sqlx::Error> for AuthError {
    fn from(err: sqlx::Error) -> Self {
        AuthError::Db(tb_db::DbError::from(err))
    }
}

/// HTTP-Statuscode, der zu jeder Variante gehört. tb-web nutzt das beim
